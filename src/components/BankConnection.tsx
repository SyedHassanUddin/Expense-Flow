...
import { Banknote, Link as LinkIcon, CheckCircle, AlertCircle, Loader, Calendar, Tag, ArrowUpRight } from 'lucide-react';
...
const BankConnection: React.FC<BankConnectionProps> = ({ onTransactionsImported, currency }) => {
  ...
  const getCategoryColor = (categories: string[]) => {
    ...
    if (category.includes('food') || category.includes('restaurant')) return 'bg-orange-100 text-orange-700';
    if (category.includes('transportation') || category.includes('gas')) return 'bg-blue-100 text-blue-700';
    if (category.includes('shop') || category.includes('retail')) return 'bg-purple-100 text-purple-700';
    if (category.includes('entertainment') || category.includes('recreation')) return 'bg-green-100 text-green-700';
    if (category.includes('utilities') || category.includes('payment')) return 'bg-yellow-100 text-yellow-700';
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8">
          ...
          {!isConnected ? (
            <div className="text-center">
              <div className="bg-blue-50 rounded-full p-6 w-20 h-20 mx-auto mb-6 flex items-center justify-center">
            ...
            <div className="text-center">
              <div className="bg-green-50 rounded-full p-6 w-20 h-20 mx-auto mb-6 flex items-center justify-center">
          ...
          <div className="grid grid-cols-3 gap-4 mt-8 pt-6 border-t border-gray-200">
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-800 text-sm mb-1">Auto Import</h4>
              <p className="text-xs text-gray-600">10-20 transactions</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-800 text-sm mb-1">Smart Tags</h4>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
              <div className="flex items-center">
                <Banknote size={20} className="text-blue-600 mr-3" />
                <div>
                  <h4 className="text-sm font-semibold text-blue-800">Demo Bank Account</h4>
                  <p className="text-sm text-blue-600">Checking Account •••• 1234</p>
                </div>
              </div>
            </div>
          </div>
